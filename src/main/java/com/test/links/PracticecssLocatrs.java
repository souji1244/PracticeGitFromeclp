...
public class PracticecssLocatrs {
	public static void main(String[] args) throws InterruptedException {
		...
		driver.get("https://www.lambdatest.com/selenium-playground");
     	...
     	//driver.findElement(By.cssSelector("a.text-black")).click();
     	//driver.findElement(By.cssSelector("#__next > div > section.mb-50 > div > ul > li:nth-child(1) > a")).click();
     	driver.findElement(By.cssSelector("a[href='https://www.lambdatest.com/selenium-playground/simple-form-demo']")).click();
